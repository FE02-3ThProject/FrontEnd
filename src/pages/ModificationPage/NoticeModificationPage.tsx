...
const NoticeModificationPage = () => {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      navigator(`/meeting/${meetingId}/${noticeId}`);
    } catch (error) {
      Swal.fire({
        text: "게시글 수정에 실패했습니다.",
        icon: "error",
  ...
  return (
    <StContainer>
      <StForm>
        ...
        <StContentLabel>공지사항 내용</StContentLabel>
        <StInput
          type="text"
          value={content}
...
export default NoticeModificationPage;
